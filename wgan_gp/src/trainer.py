...
class Trainer(object):
    ...
    def dis_step(self, stats):
        ...
        # loss_fake = F.binary_cross_entropy(output_fake, self.label_fake)
        # loss_real = F.binary_cross_entropy(output_real, self.label_real)
        ...
        loss = output_fake - output_real + gradient_penalty
    ...
    def mapping_step(self, stats):
        ...
        loss = -output_fake
        #output_real = self.discriminator(tgt_emb)       
 
        #loss = F.binary_cross_entropy(output_fake, self.label_real)
        #loss_real = F.binary_cross_entropy(output_real, self.label_fake)
        #loss = loss_fake + loss_real
