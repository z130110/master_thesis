...
def build_model(params, with_dis):
    ...
    # two discriminators
    discriminator_1 = Discriminator(params) if with_dis else None
    discriminator_2 = Discriminator(params) if with_dis else None
    ...
    return src_emb, tgt_emb, mapping, discriminator_1, discriminator_2
